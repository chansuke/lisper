...
lval* builtin_load(lenv* e, lval* a) {
  ...
  mpc_result_t r;
  if (mpc_parse_contents(a->cell[0]->str, Lisper, &r)) {
...
int main(int argc, char** argv) {
  ...
  mpca_lang(MPCA_LANG_DEFAULT,
    "                                              \
      ...
      lisper   : /^/ <expr>* /$/ ;                  \
    ",
    Number, Symbol, String, Comment, Sexpr, Qexpr, Expr, Lisper);
